...
${OBJECTDIR}/src/AtomContainer.o: src/AtomContainer.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/AtomContainer.o src/AtomContainer.cpp
...
${OBJECTDIR}/_ext/1045285602/EventsWidget.o: ../Programy/harmonySEQ/trunk/src/EventsWidget.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1045285602/EventsWidget.o ../Programy/harmonySEQ/trunk/src/EventsWidget.cpp
...
${OBJECTDIR}/src/SequencerWidget.o: src/SequencerWidget.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/SequencerWidget.o src/SequencerWidget.cpp

${OBJECTDIR}/src/Atom.o: src/Atom.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Atom.o src/Atom.cpp

${OBJECTDIR}/_ext/1045285602/ControlSequencer.o: ../Programy/harmonySEQ/trunk/src/ControlSequencer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1045285602
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1045285602/ControlSequencer.o ../Programy/harmonySEQ/trunk/src/ControlSequencer.cpp
...
${OBJECTDIR}/_ext/1045285602/seqHandle.o: ../Programy/harmonySEQ/trunk/src/seqHandle.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1045285602
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1045285602/seqHandle.o ../Programy/harmonySEQ/trunk/src/seqHandle.cpp
